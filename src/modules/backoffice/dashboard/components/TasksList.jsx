            ...
            >
              <div className="flex items-center">
                <button
                  ...
                  className={`w-5 h-5 flex-shrink-0 flex items-center justify-center rounded-full mr-3 transition-colors ${
                    task.status === 'completed'
      ...
      <CardFooter>
        <div className="flex w-full gap-2">
          <input
            ...
            className="flex-1 bg-white dark:bg-gray-800 pl-4 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
            value={newTaskTitle}
