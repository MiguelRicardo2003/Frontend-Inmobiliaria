...
const EditPropertyModal = ({ property, onClose, onSubmit, propertyTypes = [], propertyStates = [] }) => {
  ...
  useEffect(() => {
    if (property) {
      setFormData({
        ...
        tipo_id: property.tipo?.id || '',
        estado_id: property.estado?.id || ''
      });
      
      // Cargar imágenes existentes
      if (property.imagenes && Array.isArray(property.imagenes)) {
        setExistingImages(property.imagenes);
      }
    }
  }, [property]);
